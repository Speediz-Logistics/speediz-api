...
Route::prefix('delivery')->group(function () {
    ...
    Route::prefix('')->group(function () {
        ...
        Route::post('/reset-password-token', [AuthController::class, 'resetPasswordToken'])->name('delivery.public.reset-password');
    ...
    Route::middleware(['auth:api', 'delivery.access'])->group(function () {
        ...
        //reset password
        Route::post('/reset-password', [AuthController::class, 'resetPassword'])->name('delivery.reset-password');
